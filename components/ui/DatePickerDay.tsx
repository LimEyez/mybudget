...
interface DatePickerDayInterface {
    ...
    date: Date,
    showDatePickerDay: boolean
    setShowDatePickerDay: (value: boolean) => void,
}

export default function DatePickerDay({ setDate, date, setShowDatePickerDay, showDatePickerDay }: DatePickerDayInterface) {



    const onCancel = () => {
        setShowDatePickerDay(false);
    };
    ...
    return (
        <GestureHandlerRootView style={{backgroundColor: "#000000"}}>
            <Modal onRequestClose={onCancel} statusBarTranslucent={true} transparent={true} style={styles.modalContainer} animationType="fade" visible={showDatePickerDay}>
                <TouchableWithoutFeedback onPress={onCancel}>
                <View style={styles.modalContentContainer}>
                <DatePicker
                    isVisible={showDatePickerDay}
                    mode={'single'}
                    onCancel={onCancel}
                    onConfirm={onConfirm}
