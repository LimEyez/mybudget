...
export default function TicketIcon({ width = "24", height = "24", fill = "#2A2630" }: { width?: string, height?: string, fill?: string }) {
    const widthNumber = Number(width);
    const heightNumber = Number(height)
    return (
        <Svg width={width} height={height} viewBox={`0 0 24 24`} fill="none" >
            <Mask id="mask0_464_289" style={{maskType: "alpha"}} maskUnits="userSpaceOnUse" x="0" y="0" width={width} height={height}>
